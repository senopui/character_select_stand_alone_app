...
LANG_EN = {
    ...
    "api_preview_refresh_time": "Generate preview interval (0=OFF)",
    ...
    "run_skip_button": "Skip follow-up",
    "run_cancel_button": "Cancel current",
    ...
    "gr_info_cancel_current_generate": "Generate Canceled",
...
LANG_CN = {
    ...
    "api_preview_refresh_time": "预览图刷新间隔（0为关闭预览）",
    ...
    "run_skip_button": "跳过后续",
    "run_cancel_button": "取消生成",
    ...
    "gr_info_cancel_current_generate": "生成已取消",
